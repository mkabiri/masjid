package com.jimprove.oms.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.jimprove.oms.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.jimprove.oms.repository.UserRepository.USERS_BY_EMAIL_CACHE);
