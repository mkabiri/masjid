...
import { TituloComponent } from 'app/entities/titulo/titulo.component';
import { TituloService } from 'app/entities/titulo/titulo.service';
import { Titulo } from 'app/shared/model/titulo.model';

describe('Component Tests', () => {
  describe('Titulo Management Component', () => {
    let comp: TituloComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(TituloComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.titulos && comp.titulos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
