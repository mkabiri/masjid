...
import { ContributorDeleteDialogComponent } from 'app/entities/contributor/contributor-delete-dialog.component';
  ...
  describe('Contributor Management Delete Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [ContributorDeleteDialogComponent]
      })
