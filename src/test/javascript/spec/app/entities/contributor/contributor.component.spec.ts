...
import { ContributorComponent } from 'app/entities/contributor/contributor.component';
...
describe('Component Tests', () => {
  describe('Contributor Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.contributors && comp.contributors[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
